## AI News Verification Agent

An AI-powered news fact-checking agent built using the **uAgents** framework and **[ASI1 LLM](https://asi1.ai/)** with real-time web search. This agent takes a news headline or claim and determines whether it is likely real or likely fake by cross-referencing web sources, returning a clear verdict with an explanation.

### Features

- **Real-Time Fact-Checking**: Uses ASI1's web search to verify claims against current online sources
- **Clear Verdicts**: Returns structured responses with a "Likely Real" or "Likely Fake" verdict and a brief explanation citing sources
...
1. **Clone the repository**
   ...
   cd awesome-llm-apps/starter_ai_agents/ai_news_verification_agent
   ```
...
Send any news headline or claim as a message, and the agent will respond with:
